...
class TestFileManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.file_manager = FileManager(self.root_folder, self.home_page_file, self.media_folder)
    ...
    def test_get_page_path_valid(self):
        url = Path('/')
        self.assertEqual(self.file_manager.get_page_path(url), Path(self.home_page_file))
    ...
    def test_path_starts_with(self):
        self.assertTrue(self.file_manager.path_starts_with(self.root_folder, self.root_folder))
        self.assertFalse(self.file_manager.path_starts_with(self.root_folder, self.media_folder))
    ...
    def test_save_media(self, mock_file, mock_exists):
        ...
        mock_file.assert_called_once_with(os.path.join(self.media_folder, 'test.jpg'), 'wb')
